...
5. **Lead form**
  ...
  - **Submit:** Persist to **Postgres** when [spec-data-auth.md](./spec-data-auth.md) **P3** ships (`course_leads`). Until then MVP may `console.log`, show success toast, or POST a stub Route Handler.
