...
| `/tests` | Self-checks on SDD, specs, and software intent. *(when [spec-tests.md](./spec-tests.md) P1 ships; 50–58 chars)* | `/images/og-tests.png` or default until art exists |
