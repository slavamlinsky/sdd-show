---
title: "What spec-driven development means when you really build."
slug: "what-is-spec-driven-development"
date: "2026-05-09"
description: "Spec-driven development means intent, behavior, and done live in one place you can check. See how that differs from tickets, plus a slice you can copy."
...
That gap between a friendly room and a shared picture of the work is where [spec-driven development](/glossary#spec-driven-development) helps. It is not a contest for the longest doc. It is a habit of putting intent, behavior, and done in one place your team can read and test against. Ideally before ship, or right beside the code if you iterate fast.
...
Many teams pair this with [intent-driven thinking](/blog/intent-driven-engineering): start from what people need from the system, not from the first API that came to mind.
...
A backlog of neat titles is still not a spec. The spec can sit in the ticket, a wiki page, or Markdown in the repo. It still has to answer what you are building and how you will know, not only the due date. For the tracking vs meaning split, see [tickets vs specs](/blog/tickets-vs-specs).
...
To run that loop with examples, start the [course](/course). For how teams actually practice SDD, see [approaches in the ecosystem](/ecosystem#approaches).
